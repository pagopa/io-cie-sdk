...
#ifndef IOCIESDKIOS_SWIFT_H
#define IOCIESDKIOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="iociesdkios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("CIEIDSdk") SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface CIEIDSdk : NSObject
...
SWIFT_CLASS("_TtC11iociesdkios11ErrorHelper")
@interface ErrorHelper : NSObject
+ (NSString * _Nonnull)decodeErrorWithError:(uint16_t)error SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC11iociesdkios8NFCToken") SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface NFCToken : NSObject
- (NSData * _Nonnull)transmitWithApdu:(NSData * _Nonnull)apdu SWIFT_WARN_UNUSED_RESULT;
